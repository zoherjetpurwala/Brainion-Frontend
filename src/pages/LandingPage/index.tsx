    ...
    <div>
      ...
      <main className="flex-1 w-full lg:mx-auto">
        <div className="flex relative flex-col gap-4 justify-center items-center w-full">
          ...
          <HeroComponent />
          <div className="relative mt-5 h-[200px] md:h-[400px] overflow-hidden w-full">
            <img
              src="/dashboard.png"
              alt="Dashboard preview"
              className="absolute  top-16 md:top-0 left-1/2 -translate-x-1/2 border-[10px] border-blue-900/65 rounded-3xl object-contain md:w-1/2 w-[95%]"
            />
          </div>
        </div>
      </main>
