...
const HeroComponent = () => {
  return (
    <div className="flex flex-col gap-20 items-center px-6 pb-12 lg:pb-16 pt-32 lg:gap-8 md:pt-40 lg:pt-52">
      ...
      <div className="flex flex-col w-full max-w-7xl justify-center items-center gap-8">
        ...
        <div className="flex flex-col">
          <Button className="bg-blue-800 hover:bg-blue-950 text-white font-medium rounded-full px-8 py-6 text-lg">
